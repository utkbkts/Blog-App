...
const CreatePostList = () => {
  ...
  const handleImage = (result: CldUploadWidgetResults) => {
    ...
    <div>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={AddLink}
            className="btn flex gap-2 items-center dark:text-black"
          >
            <span>
              <svg
        ...
        <div>
          <select
            className="w-full py-2 px-4 border dark:text-black border-gray-300 outline-none rounded-md"
        ...
        <button
          type="submit"
          className={`py-2 px-4 rounded-md w-full bg-gray-900 text-white ${Loading ? "bg-gray-700":""}`}
        >
          {Loading ? (
